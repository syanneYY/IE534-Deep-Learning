...
# tokens = [['a'],['i']] # generating two reviews.
...
review = []
####
#We use the previous output, perform the softmax function (assign probability of 0.0 to token id 0 to ignore the unknown token),
# #randomly sample based on probs, save these indices to the list review, and finally get another output
...
## convert the token ids to their corresponding string
## all of the indices need -1 to account for the unknown token
