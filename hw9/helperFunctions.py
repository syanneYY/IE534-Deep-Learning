...
##grabs a random subsequence of frames and augments them all in the exact same way (this is important when performing data augmentation on videos)
...
def loadSequence(args):
    ...
    try:
        ...
        data = np.array([])
    return data
    # the last three channels of an input with
    # size [batch_size,num_of_input_features,time,height,width]



# the dataset has a large number of frames (13000 videos * number of frames per video)
