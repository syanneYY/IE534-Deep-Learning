...
# max pooling operations over the spatial and temporal dimensions as well as strided 3D convolutions
# which will reduce the spatial and temporal dimensions by a factor of 2.
...
#     param.requires_grad_(True)
# directly send the output of model.layer4[0] into the fully connected layer.
# we will simply ignore these last two blocks.
...
for epoch in range(0, num_of_epochs):
    ...
    for i in range(0, len(train[0]) - batch_size, batch_size):
        ...
        # The input x will now be size[batch_size, 3, 16, 224, 224].
        next_batch = 0
        for video in data:
